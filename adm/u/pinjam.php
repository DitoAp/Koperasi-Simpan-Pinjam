...
if (($s == "baru") OR ($s == "edit"))
	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			Detail Pelanggan :
			<br>
			<input name="d_pembeli" id="d_pembeli" type="text" value="'.$i_p_detail.'" size="10" class="btn btn-block btn-default" readonly>
			</p>
	...
	<input name="btnSMP31" type="submit" value="SIMPAN >>" class="btn btn-block btn-danger">
  ...
  <script>
	...
	if ($count != 0)
		...
		do 
			...
			$i_dp_nominal = xduit3(balikin($data['kredit_dp_nominal']));
			...
			<td>'.$i_a_ke.'</td>
			<td>'.$i_dp_tgl.'</td>
			<td align="right">'.$i_dp_nominal.'</td>
